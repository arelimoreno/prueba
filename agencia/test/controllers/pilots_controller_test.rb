...
class PilotsControllerTest < ActionController::TestCase
  ...
  test "should create pilot" do
    assert_difference('Pilot.count') do
      post :create, pilot: { cargo: @pilot.cargo, edad: @pilot.edad, identificacion: @pilot.identificacion, name: @pilot.name }
    end
  ...
  test "should update pilot" do
    patch :update, id: @pilot, pilot: { cargo: @pilot.cargo, edad: @pilot.edad, identificacion: @pilot.identificacion, name: @pilot.name }
    assert_redirected_to pilot_path(assigns(:pilot))
  end
