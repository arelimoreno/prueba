...
class AirplanesControllerTest < ActionController::TestCase
  ...
  test "should create airplane" do
    assert_difference('Airplane.count') do
      post :create, airplane: { aerolinea: @airplane.aerolinea, capacidad: @airplane.capacidad, codigo: @airplane.codigo, modelo: @airplane.modelo, nombre: @airplane.nombre }
    end
  ...
  test "should update airplane" do
    patch :update, id: @airplane, airplane: { aerolinea: @airplane.aerolinea, capacidad: @airplane.capacidad, codigo: @airplane.codigo, modelo: @airplane.modelo, nombre: @airplane.nombre }
    assert_redirected_to airplane_path(assigns(:airplane))
  end
